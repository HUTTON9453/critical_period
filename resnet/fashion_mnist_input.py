...
# full_data_dir = 'fashion_minist_data/cifar-10-batches-py/data_batch_'
# vali_dir = 'fashion_mnist_data/cifar-10-batches-py/test_batch'
# DATA_URL = ''
...
def read_in_all_images(address_list, shuffle=True, is_random_label = False):
    ...
    # This re# shape order is really important. Don't change
...
def prepare_train_data(padding_size):
    ...
    (data, label), (test_images, test_labels) = fashion_mnist.load_data()
...
def read_validation_data():
    ...
    (train_images, train_labels), (validation_array, validation_labels) = fashion_mnist.load_data()
    validation_array = np.expand_dims(validation_array, axis = -1)
