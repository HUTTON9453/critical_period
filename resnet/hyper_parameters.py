...
tf.app.flags.DEFINE_integer('blur_steps', 0, '''Blur steps that you want to train''')
tf.app.flags.DEFINE_integer('train_steps', 80000+FLAGS.blur_steps, '''Total steps that you want to train''')
...
tf.app.flags.DEFINE_float('lr_decay_factor', 0.97, '''How much to decay the learning rate each
time''')
tf.app.flags.DEFINE_integer('decay_step0', 30000, '''At which step to decay the learning rate''')
...
tf.app.flags.DEFINE_float('weight_decay', 0.0005, '''scale for l2 regularization''')
